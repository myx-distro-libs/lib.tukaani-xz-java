 ...
 * System.out.println("Encoder memory usage: " + FilterOptions.getEncoderMemoryUsage(options) + " KiB");
 * System.out.println("Decoder memory usage: " + FilterOptions.getDecoderMemoryUsage(options) + " KiB");
...
public class XZOutputStream extends FinishableOutputStream {
     ...
     */
    public XZOutputStream(final OutputStream out, final FilterOptions filterOptions) throws IOException {
     ...
     *             may be thrown from <code>out</code>
     */
    public XZOutputStream(final OutputStream out, final FilterOptions filterOptions, final int checkType)
	    throws IOException {
    ...
    private void encodeStreamFlags(final byte[] buf, final int off) {
	buf[off] = 0x00;
	...
	final long backwardSize = this.index.getIndexSize() / 4 - 1;
	for (int i = 0; i < 4; ++i) {
	...
	final FilterOptions[] opts = new FilterOptions[1];
	...
	if (this.blockEncoder != null) {
	    throw new UnsupportedOptionsException(
		    "Changing filter options " + "in the middle of a XZ Block not implemented");
	}
	...
	final FilterEncoder[] newFilters = new FilterEncoder[filterOptions.length];
